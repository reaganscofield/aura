# Generated by Django 2.2.2 on 2019-08-08 06:27
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address_suburb', models.CharField(max_length=250)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.CharField(max_length=250)),
                ('phone_number', models.IntegerField()),
                ('current_location_street', models.CharField(max_length=250)),
                ('current_location_suburb', models.CharField(max_length=250)),
                ('current_location_city', models.CharField(max_length=250)),
                ('current_location_country', models.CharField(max_length=250)),
                ('current_location_zip', models.IntegerField()),
                ('is_active', models.BooleanField(default=True)),
                ('timestamp', models.DateField(auto_now_add=True)),
                ('company_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='aura_backend.Companies')),
                ('vehicule_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='aura_backend.Vehicule')),
            ],
        ),
        migrations.CreateModel(
            name='Panics',
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('panics_name', models.CharField(max_length=250)),
                ('is_active', models.BooleanField(default=True)),
                ('timestamp', models.DateField(auto_now_add=True)),
